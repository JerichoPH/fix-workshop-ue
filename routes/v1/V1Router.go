...
func (cls *V1Router) Load() {
	(&AuthorizationRouter{Router: cls.Router, MySqlConn: cls.MySqlConn, MsSqlConn: cls.MsSqlConn, AppConfig: cls.AppConfig, DBConfig: cls.DBConfig}).Load() // 权鉴
	(&AccountRouter{Router: cls.Router, MySqlConn: cls.MySqlConn, MsSqlConn: cls.MsSqlConn, AppConfig: cls.AppConfig, DBConfig: cls.DBConfig}).Load()       // 用户
