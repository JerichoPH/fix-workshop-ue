...
type EntireInstanceUseModel struct {
	...
	LocationInstallPosition            LocationInstallPositionModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationInstallPositionUniqueCode;references:UniqueCode;COMMENT:所属室内上道位置;" json:"location_install_position"`
	...
	PrevLocationInstallPosition           LocationInstallPositionModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationInstallPositionUniqueCode;references:UniqueCode;COMMENT:上一次所属室内上道位置;" json:"prev_location_install_position"`
	...
	LocationSignalPostMainOrIndicator                 LocationSignalPostMainOrIndicatorModel   `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationSignalPostMainOrIndicatorUniqueCode;references:UniqueCode;COMMENT:所属信号灯主机或表示器;" json:"location_signal_post_main_or_indicator"`
	...
	PrevLocationSignalPostMainOrIndicator             LocationSignalPostMainOrIndicatorModel   `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationSignalPostMainOrIndicatorUniqueCode;references:UniqueCode;COMMENT:上一次所属信号灯主机或表示器;" json:"prev_location_signal_post_main_or_indicator"`
	...
	LocationSignalPostMainLightPosition               LocationSignalPostMainLightPositionModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationSignalPostMainLightPositionUniqueCode;references:UniqueCode;COMMENT:所属信号灯主机灯位代码;" json:"location_signal_post_main_light_position"`
	...
	PrevLocationSignalPostMainLightPosition                LocationSignalPostMainLightPositionModel      `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationSignalPostMainLightPositionUniqueCode;references:UniqueCode;COMMENT:上一次所属信号灯主机灯位代码;" json:"prev_location_signal_post_main_light_position"`
	...
	LocationSignalPostIndicatorLightPosition               LocationSignalPostIndicatorLightPositionModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationSignalPostIndicatorLightPositionUniqueCode;references:UniqueCode;COMMENT:所属信号灯表示器灯位代码;" json:"location_signal_post_indicator_light_position"`
	...
	PrevLocationSignalPostIndicatorLightPosition           LocationSignalPostIndicatorLightPositionModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationSignalPostIndicatorLightPositionUniqueCode;references:UniqueCode;COMMENT:上一次所属信号灯表示器灯位代码;" json:"prev_location_signal_post_indicator_light_position"`
