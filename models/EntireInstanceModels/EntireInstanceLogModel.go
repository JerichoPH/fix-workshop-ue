...
type EntireInstanceLogModel struct {
	...
	Operator                                 models.AccountModel                                    `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OperatorId;references:ID;COMMENT:所属操作人;" json:"operator"`
	OrganizationParagraphUniqueCode          string                                                 `gorm:"type:CHAR(4);NOT NULL;COMMENT:所属站段代码;" json:"organization_paragraph_unique_code"`
	OrganizationParagraph                    OrganizationModels.OrganizationParagraphModel          `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationParagraphUUID;references:UniqueCode;NOT NULL;COMMENT:所属站段;" json:"organization_paragraph"`
	OrganizationWorkshopUniqueCode           string                                                 `gorm:"type:CHAR(7);COMMENT:所属车间代码;" json:"organization_workshop_unique_code"`
	OrganizationWorkshop                     OrganizationModels.OrganizationWorkshopModel           `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationWorkshopUUID;references:UniqueCode;COMMENT:所属车间;" json:"organization_workshop"`
	OrganizationWorkAreaUniqueCode           string                                                 `gorm:"type:CHAR(8);COMMENT:所属工区代码;" json:"organization_work_area_unique_code"`
	OrganizationWorkArea                     OrganizationModels.OrganizationWorkAreaModel           `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationWorkAreaUUID;references:UniqueCode;COMMENT:所属工区;" json:"organization_work_area"`
	...
	OrganizationRailroadGradeCross           OrganizationModels.OrganizationRailroadGradeCrossModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationRailroadGradeCrossUUID;references:UniqueCode;COMMENT:所属道口;" json:"organization_railroad_grade_cross"`
	OrganizationCenterUniqueCode             string                                                 `gorm:"type:CHAR(6);COMMENT:所属中心代码;" json:"organization_center_unique_code"`
	OrganizationCenter                       OrganizationModels.OrganizationCenterModel             `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationCenterUUID;references:UniqueCode;COMMENT:所属中心;" json:"organization_center"`
	OrganizationStationUniqueCode            string                                                 `gorm:"type:CHAR(6);COMMENT:所属站场代码;" json:"organization_station_unique_code"`
	OrganizationStation                      OrganizationModels.OrganizationStationModel            `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationStationUUID;references:UniqueCode;COMMENT:所属站场;" json:"organization_station"`
