...
import (
	...
	"fix-workshop-ue/models/KindModels"
...
type EntireInstanceModel struct {
	...
	KindCategory                   KindModels.KindCategoryModel                `gorm:"foreignKey:KindCategoryUniqueCode;references:UniqueCode;COMMENT:所属种类;" json:"kind_category"`
	KindEntireTypeUniqueCode       string                                      `gorm:"type:CHAR(5);COMMENT:所属类型;" json:"kind_entire_model_unique_code"`
	KindEntireType                 KindModels.KindEntireTypeModel              `gorm:"foreignKey:KindEntireTypeUniqueCode;references:UniqueCode;COMMENT:所属类型;" json:"kind_entire_model"`
	KindSubTypeUniqueCode          string                                      `gorm:"type:CHAR(7);COMMENT:所属型号;" json:"kind_sub_model_unique_code"`
	KindSubModel                   KindModels.KindSubTypeModel                 `gorm:"foreignKey:KindSubTypeUniqueCode;references:UniqueCode;COMMENT:所属型号;" json:"kind_sub_model"`
	...
	OrganizationRailway            OrganizationModels.OrganizationRailwayModel `gorm:"foreignKey:OrganizationRailwayUUID;references:UUID;COMMENT:所属路局;" json:"organization_railway"`
	OrganizationParagraphUUID      string                                      `gorm:"type:CHAR(36);COMMENT:所属站段;" json:"organization_paragraph_unique_code"`
	OrganizationParagraph          OrganizationModels.OrganizationParagraphModel `gorm:"foreignKey:OrganizationParagraphUUID;references:UUID;COMMENT:所属站段;" json:"organization_paragraph"`
	OrganizationWorkshopUUID       string                                        `gorm:"type:CHAR(36);COMMENT:所属车间;" json:"organization_workshop_uuid"`
	OrganizationWorkshop           OrganizationModels.OrganizationWorkshopModel  `gorm:"foreignKey:OrganizationWorkshopUUID;references:UUID;COMMENT:所属专业车间;" json:"organization_workshop"`
	OrganizationWorkAreaUUID       string                                        `gorm:"type:CHAR(36);COMMENT:所属工区;" json:"organization_work_area_uuid"`
	OrganizationWorkArea           OrganizationModels.OrganizationWorkAreaModel  `gorm:"foreignKey:OrganizationWorkAreaUUID;references:UUID;COMMENT:所属专业工区;" json:"organization_work_area"`
	...
	SourceType                     models.SourceTypeModel                        `gorm:"foreignKey:SourceTypeUUID;references:UUID;COMMENT:所属来源类型;" json:"source_type"`
	SourceNameUUID                 string                                        `gorm:"type:CHAR(36);COMMENT:来源名称代码;" json:"source_name_UUID"`
	SourceName                     models.SourceNameModel                        `gorm:"foreignKey:SourceNameUUID;references:UUID;COMMENT:所属来源名称;" json:"source_name"`
	...
	Factory                        models.FactoryModel                           `gorm:"foreignKey:FactoryUUID;references:UUID;COMMENT:所属供应商;" json:"factory"`
	...
	DeleteOperator     models.AccountModel `gorm:"foreignKey:DeleteOperatorUUID;references:UUID;COMMENT:删除操作人;" json:"delete_operator"`
}
