...
type KindEntireTypeModel struct {
	...
	KindSubModels          []KindSubTypeModel    `gorm:"<-;constraint:OnUpdate:CASCADE;foreignKey:KindEntireModelUniqueCode;references:UniqueCode;COMMENT:相关型号;" json:"kind_sub_models"`
	EntireInstances        []EntireInstanceModel `gorm:"<-;constraint:OnUpdate:CASCADE;foreignKey:KindEntireModelUniqueCode;references:UniqueCode;COMMENT:相关器材;" json:"entire_instances"`
}
