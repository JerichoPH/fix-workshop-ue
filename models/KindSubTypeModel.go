...
type KindSubTypeModel struct {
	...
	KindEntireType           KindEntireTypeModel   `gorm:"foreignKey:KindEntireTypeUniqueCode;references:UniqueCode;" json:"kind_entire_type"`
	EntireInstances          []EntireInstanceModel `gorm:"foreignKey:KindSubTypeUniqueCode;references:UniqueCode;COMMENT:相关器材;" json:"entire_instances"`
}
