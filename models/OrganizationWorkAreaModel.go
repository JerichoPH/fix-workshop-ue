...
type OrganizationWorkAreaModel struct {
	...
	OrganizationWorkAreaProfessionUUID string                              `gorm:"type:CHAR(36);COMMENT:所属工区专业;" json:"organization_work_area_profession_uuid"`
	OrganizationWorkAreaProfession     OrganizationWorkAreaProfessionModel `gorm:"foreignKey:OrganizationWorkAreaProfessionUUID:references:UUID;COMMENT:所属工区专业;" json:"organization_work_area_profession"`
