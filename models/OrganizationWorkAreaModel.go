...
type OrganizationWorkAreaModel struct {
	...
	OrganizationWorkAreaTypeUUID       string                              `gorm:"type:CHAR(36);COMMENT:所属工区类型UUID;" json:"organization_work_area_type_uuid"`
	...
	OrganizationWorkAreaProfessionUUID string                              `gorm:"type:CHAR(36);COMMENT:所属工区专业UUID;" json:"organization_work_area_profession_uuid"`
