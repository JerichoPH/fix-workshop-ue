...
type PositionIndoorRoomModel struct {
	...
	LocationRailroadGradeCrossUuid string                          `gorm:"type:VARCHAR(36);COMMENT:所属道口UUID;" json:"location_railroad_grade_cross_uuid"`
	LocationRailroadGradeCross     LocationRailroadGradeCrossModel `gorm:"foreignKey:LocationRailroadGradeCrossUuid;COMMENT:所属道口;" json:"location_railroad_grade_cross"`
