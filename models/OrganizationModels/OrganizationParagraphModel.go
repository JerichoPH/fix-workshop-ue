...
type OrganizationParagraphModel struct {
	...
	EntireInstances         []EntireInstanceModels.EntireInstanceModel `gorm:"foreignKey:OrganizationParagraphUUID;references:UUID;COMMENT:相关器材;" json:"entire_instances"`
	LocationDepotStorehouse []LocationDepotStorehouseModel             `gorm:"foreignKey:OrganizationParagraphUUID;references:UUID;NOT NULL;COMMENT:相关仓库;" json:"location_depots"`
}
