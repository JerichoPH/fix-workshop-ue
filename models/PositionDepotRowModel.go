...
type PositionDepotRowModel struct {
	...
	PositionDepotRowTypeUUID string                      `gorm:"type:CHAR(36);COMMENT:所属仓储仓库排类型UUID;" json:"position_depot_row_type_uuid"`
	...
	PositionDepotSectionUUID string                      `gorm:"type:CHAR(36);COMMENT:所属仓储仓库区域UUID;" json:"position_depot_section_uuid"`
