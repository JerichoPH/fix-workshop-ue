...
type OrganizationWorkshopModel struct {
	...
	LocationDepotStorehouses            []LocationDepotStorehouseModel        `gorm:"foreignKey:OrganizationWorkshopUUID;references:UUID;COMMENT:相关仓储库房;" json:"location_depot_storehouses"`
