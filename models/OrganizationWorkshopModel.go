...
type OrganizationWorkshopModel struct {
	...
	LocationRailroadGradeCrossModel []LocationRailroadModel        `gorm:"foreignKey:OrganizationWorkshopUuid;references:Uuid;COMMENT:相关道口;" json:"location_railroad_grade_crosses"`
