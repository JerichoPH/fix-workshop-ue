...
type OrganizationWorkshopModel struct {
	...
	//EntireInstances              []EntireInstanceModel         `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationWorkshopUUID;references:UniqueCode;COMMENT:所属器材;" json:"entire_instances"`
}
