...
type LocationWarehousePlatoonTypeModel struct {
	...
	LocationWarehousePlatoons []LocationWarehousePlatoonModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationWarehousePlatoonTypeUniqueCode;references:UniqueCode;NOT NULL;COMMENT:相关排;" json:"location_warehouse_platoons"`
}
