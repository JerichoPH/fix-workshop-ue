...
type LocationDepotSectionModel struct {
	...
	LocationWarehousePlatoons   []LocationDepotRowModel      `gorm:"foreignKey:LocationWarehouseAreaUniqueCode;references:UUID;NOT NULL;COMMENT:相关排;" json:"location_warehouse_platoons"`
}
