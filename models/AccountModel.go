...
type AccountModel struct {
	...
	OrganizationRailwayUUID   string                     `gorm:"type:CHAR(36);NOT NULL;DEFAULT:;COMMENT:所属路局UUID;" json:"organization_railway_uuid"`
	...
	OrganizationParagraphUUID string                     `gorm:"type:CHAR(36);NOT NULL;DEFAULT:;COMMENT:所属站段UUID;" json:"organization_paragraph_uuid"`
	...
	OrganizationWorkshopUUID  string                     `gorm:"type:CHAR(36);NOT NULL;DEFAULT:;COMMENT:所属车间UUID;" json:"organization_workshop_uuid"`
	...
	OrganizationWorkAreaUUID  string                     `gorm:"type:CHAR(36);NOT NULL;DEFAULT:;COMMENT:所属工区UUID;" json:"organization_work_area_uuid"`
