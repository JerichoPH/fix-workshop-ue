...
type AccountModel struct {
	...
	RbacRoles                 []*RbacRoleModel           `gorm:"many2many:pivot_rbac_role_and_accounts;foreignKey:uuid;joinForeignKey:account_uuid;References:id;joinReferences:rbac_role_uuid;COMMENT:角色与用户多对多;" json:"rbac_roles"`
