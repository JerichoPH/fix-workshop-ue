...
type EntireInstanceLogModel struct {
	...
	LocationRailroadUuid            string                     `gorm:"VARCHAR(36);COMMENT:所属道口UUID;" json:"location_railroad_uuid"`
	LocationRailroad                LocationRailroadModel      `gorm:"foreignKey:LocationRailroadUuid;references:Uuid;COMMENT:所属道口;" json:"location_railroad"`
}
