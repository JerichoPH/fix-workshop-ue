...
type EntireInstanceLogModel struct {
	...
	OperatorUUID                    uint64                          `gorm:"type:CHAR(36);COMMENT:操作人编号;" json:"operator_uuid"`
