...
type EntireInstanceLogModel struct {
	...
	OrganizationRailroadGradeCross           LocationRailroadGradeCrossModel `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationRailroadGradeCrossUUID;references:UniqueCode;COMMENT:所属道口;" json:"organization_railroad_grade_cross"`
	OrganizationCenterUniqueCode             string                          `gorm:"type:CHAR(6);COMMENT:所属中心代码;" json:"organization_center_unique_code"`
	OrganizationCenter                       LocationCenterModel             `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationCenterUUID;references:UniqueCode;COMMENT:所属中心;" json:"organization_center"`
	OrganizationStationUniqueCode            string                          `gorm:"type:CHAR(6);COMMENT:所属站场代码;" json:"organization_station_unique_code"`
	OrganizationStation                      LocationStationModel            `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationStationUUID;references:UniqueCode;COMMENT:所属站场;" json:"organization_station"`
