...
type KindCategoryModel struct {
	...
	KindEntireTypes []KindEntireTypeModel `gorm:"foreignKey:KindCategoryUniqueCode;references:UniqueCode;" json:"kind_entire_types"`
	EntireInstances []EntireInstanceModel `gorm:"foreignKey:KindCategoryUniqueCode;references:UniqueCode;NOT NULL;COMMENT:相关器材;" json:"entire_instances"`
}
