...
type RbacRoleModel struct {
	...
	Accounts        []*models.AccountModel `gorm:"many2many:pivot_rbac_role_and_accounts;foreignKey:id;joinForeignKey:rbac_role_id;references:id;joinReferences:account_id;COMMENT:角色与用户多对多;" json:"accounts"`
	Menus           []*models.MenuModel    `gorm:"many2many:pivot_rbac_role_and_menus;foreignKey:id;joinForeignKey:rbac_role_id;references:id;joinReferences:menu_id;COMMENT:角色与菜单多对多;" json:"menus"`
}
