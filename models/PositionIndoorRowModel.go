...
type PositionIndoorRowModel struct {
	BaseModel
	UniqueCode             string                       `gorm:"type:CHAR(9);NOT NULL;COMMENT:排代码;" json:"unique_code"`
	Name                   string                       `gorm:"type:VARCHAR(64);NOT NULL;COMMENT:排名称;" json:"name"`
	PositionIndoorRoomUUID string                       `gorm:"type:CHAR(36);NOT NULL;" json:"position_install_room_unique_code"`
