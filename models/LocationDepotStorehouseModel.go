...
type LocationDepotStorehouseModel struct {
	...
	OrganizationRailroadGradeCrossUniqueCode string                              `gorm:"type:CHAR(36);COMMENT:所属道口;" json:"organization_railroad_grade_cross_uuid"`
	OrganizationRailroadGradeCross           OrganizationRailroadGradeCrossModel `gorm:"foreignKey:OrganizationRailroadGradeCrossUUID;references:UUID;NOT NULL;COMMENT:所属道口;" json:"organization_railroad_grade_cross"`
	...
	LocationWarehouseAreas                   []LocationDepotSectionModel         `gorm:"foreignKey:LocationDepotStorehouseUUID;references:UniqueCode;NOT NULL;COMMENT:相关区;" json:"location_warehouse_areas"`
}
