...
type EntireInstanceUse struct {
	...
	OrganizationLine                                       OrganizationLine                         `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationLineUniqueCode;references:UniqueCode;COMMENT:所属线别;" json:"organization_line"`
	PrevOrganizationLineUniqueCode                         string                                   `gorm:"type:CHAR(5);COMMENT:上一次线别代码;" json:"prev_organization_line_unique_code"`
	PrevOrganizationLine                                   OrganizationLine                         `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevOrganizationLineUniqueCode;references:UniqueCode;COMMENT:上一次所属线别;" json:"prev_organization_line"`
	...
	PrevOrganizationWorkshop                               OrganizationWorkshop                     `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevOrganizationWorkshopUniqueCode;references:UniqueCode;COMMENT:上一次所属车间;" json:"prev_organization_workshop"`
	OrganizationStationUniqueCode                          string                                   `gorm:"type:CHAR(6);COMMENT:所属车站代码;" json:"organization_station_unique_code"`
	OrganizationStation                                    OrganizationStation                      `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationStationUniqueCode;references:UniqueCode;COMMENT:所属车间;" json:"organization_station"`
	PrevOrganizationStationUniqueCode                      string                                   `gorm:"type:CHAR(6);COMMENT:上一次所属车站代码;" json:"prev_organization_station_unique_code"`
	PrevOrganizationStation                                OrganizationStation                      `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevOrganizationWorkshopUniqueCode;references:UniqueCode;COMMENT:上一次所属车间;" json:"prev_organization_station"`
	...
	PrevOrganizationWorkArea                               OrganizationWorkArea                     `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevOrganizationWorkAreaUniqueCode;references:UniqueCode;COMMENT:上一次所属工区;" json:"prev_organization_work_area"`
	...
	LocationInstallPosition                                LocationInstallPosition                  `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationInstallPositionUniqueCode;references:UniqueCode;COMMENT:所属室内上道位置;" json:"location_install_position"`
	...
	PrevLocationInstallPosition                            LocationInstallPosition                  `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationInstallPositionUniqueCode;references:UniqueCode;COMMENT:上一次所属室内上道位置;" json:"prev_location_install_position"`
	...
	OrganizationSection                                    OrganizationSection                      `gorm:"constraint:OnUpdate:CASCADE;foreignKey:OrganizationSectionUniqueCode;references:UniqueCode;COMMENT:所属区间;" json:"organization_section"`
	OrganizationSectionUniqueCode                          string                                   `gorm:"type:CHAR(6);COMMENT:所属区间代码;" json:"organization_section_unique_code"`
	PrevOrganizationSection                                OrganizationSection                      `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevOrganizationSectionUniqueCode;references:UniqueCode;COMMENT:上一次所属区间;" json:"prev_organization_section"`
	...
	LocationSignalPostMainOrIndicator                      LocationSignalPostMainOrIndicator        `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationSignalPostMainOrIndicatorUniqueCode;references:UniqueCode;COMMENT:所属信号灯主机或表示器;" json:"location_signal_post_main_or_indicator"`
	...
	PrevLocationSignalPostMainOrIndicator                  LocationSignalPostMainOrIndicator        `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationSignalPostMainOrIndicatorUniqueCode;references:UniqueCode;COMMENT:上一次所属信号灯主机或表示器;" json:"prev_location_signal_post_main_or_indicator"`
	...
	LocationSignalPostMainLightPosition                    LocationSignalPostMainLightPosition      `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationSignalPostMainLightPositionUniqueCode;references:UniqueCode;COMMENT:所属信号灯主机灯位代码;" json:"location_signal_post_main_light_position"`
	...
	PrevLocationSignalPostMainLightPosition                LocationSignalPostMainLightPosition      `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationSignalPostMainLightPositionUniqueCode;references:UniqueCode;COMMENT:上一次所属信号灯主机灯位代码;" json:"prev_location_signal_post_main_light_position"`
	...
	LocationSignalPostIndicatorLightPosition               LocationSignalPostIndicatorLightPosition `gorm:"constraint:OnUpdate:CASCADE;foreignKey:LocationSignalPostIndicatorLightPositionUniqueCode;references:UniqueCode;COMMENT:所属信号灯表示器灯位代码;" json:"location_signal_post_indicator_light_position"`
	...
	PrevLocationSignalPostIndicatorLightPosition           LocationSignalPostIndicatorLightPosition `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevLocationSignalPostIndicatorLightPositionUniqueCode;references:UniqueCode;COMMENT:上一次所属信号灯表示器灯位代码;" json:"prev_location_signal_post_indicator_light_position"`
	...
	PrevOrganizationRailroadGradeCross                     OrganizationRailroadGradeCross           `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevOrganizationRailroadGradeCrossUniqueCode;references:UniqueCode;COMMENT:上一次所属道口;" json:"prev_organization_railroad_grade_cross"`
	...
	PrevOrganizationCenter                                 OrganizationCenter                       `gorm:"constraint:OnUpdate:CASCADE;foreignKey:PrevOrganizationCenterUniqueCode;references:UniqueCode;COMMENT:上一次所属中心;" json:"prev_organization_center"`
}
